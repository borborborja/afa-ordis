...
- Quan una persona tutora accepta una invitació, completa un assistent inicial amb les dades de contacte i la fitxa de cada infant. Les fitxes antigues mostren un avís de dades pendents, però no bloquegen les reserves.
